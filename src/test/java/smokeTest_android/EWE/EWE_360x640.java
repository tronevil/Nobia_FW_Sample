...
import smokeTest_android.BaseTest_360x640;
...
public class EWE_360x640 extends BaseTest_360x640 {
    ...
    final static Logger logger = Logger.getLogger(EWE_360x640.class);
