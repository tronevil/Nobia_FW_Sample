...
public class EWE extends BaseTestDesktop {
    ...
    final static Logger logger = Logger.getLogger(EWE.class);
    ...
    public void Step1_Search() throws Exception {
        generalMethods.printTestName("======Start testing Step 6: Search Page======");
        ...
        if (!generalMethods.compareImages2(folderName, "Step1.1", ewePageObject.getSearchMask()))
            //If FALSE, add step name to the error list
        ...
        if (!generalMethods.compareImages2(folderName, "Step1.2", null))
            //If FALSE, add step name to the error list
    ...
    public void Step2_FindStore() throws Exception {
        ...
        //Take screenshot of the entire page and do the comparison
        if (!generalMethods.compareImages2(folderName, "Step2.4", null))
            //If FALSE, add step name to the error list
        ...
        //Take screenshot of the entire page and do the comparison
        if (!generalMethods.compareImages2(folderName, "Step2.5", null))
            //If FALSE, add step name to the error list
        ...
        //Take screenshot of the entire page and do the comparison
        if (!generalMethods.compareImages2(folderName, "Step2.6", null))
            //If FALSE, add step name to the error list
    ...
    public void Step3_OrderCatalogue() throws Exception {
        ...
        if (!generalMethods.compareResult(url.contains(orderCatalogPage),
            ...
            errorList.add("Step 1");
        //Take screenshot of the entire page and compare
        if (!generalMethods.compareImages2(folderName, "Step3.1", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 1 - image");
        ...
        if (!generalMethods.compareImages2(folderName, "Step3.2", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 2 - image");
        ...
        //Take screenshot of the entire page and compare
        if (!generalMethods.compareImages2(folderName, "Step3.3", null))
            //If FALSE, add step name to the error list
    ...
    public void Step4_ProductOverview() throws Exception {
        ...
        //Take screenshot of the entire page and compare
        if (!generalMethods.compareImages2(folderName, "Step4.1", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 1 - image");
        ...
        //Take screenshot of the entire page and compare
        if (!generalMethods.compareImages2(folderName, "Step4.2", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 2 - image");
    ...
    public void Step5_KitchenConfigurator() throws Exception {
        ...
        generalMethods.openURL(testEnvironment, 10);
        generalMethods.hoverOnOneOfElement(ewePageObject.getHeaderItems(), 1);
        generalMethods.clickOnOneOfElements(ewePageObject.getHeaderMenuLinks(), 2);
        ...
        //Take screenshot of the entire page and compare
        if (!generalMethods.compareImages2(folderName, "Step5.1", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 1 - image");
        ...
        if (!generalMethods.compareResult(driver.getCurrentUrl().contains(url),
            ...
            errorList.add("Step 2 - Link");
        //Take screenshot of the entire page and compare
        if (!generalMethods.compareImages2(folderName, "Step5.2", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 2 - image");
        ...
        if (!generalMethods.compareImages2(folderName, "Step5.3", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 3 - image");
    ...
    public void Step6_Kitchenality() throws Exception {
        ...
        //Take screenshot of the entire page and do the comparison
        if (!generalMethods.compareImages2(folderName, "Step6.2", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 2 - image");
    ...
    public void Step7_Magazine() throws Exception {
        ...
        //Check if Pop-up is displayed. If yes, close it and set popupDisplayed to True so the next check of pop-up will not execute the unnecessary action
        popupDisplayed = generalMethods.checkDisplayed(popupDisplayed, ewePageObject.getKitchenalityPopupClose());
        if (!generalMethods.compareImages2(folderName, "Step7.1", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 1 - image");
        ...
        if (articles > 0) {
            ...
            if (!generalMethods.compareResult(driver.getCurrentUrl().contains(url),
                ...
                //If FALSE, add step name to the error list
                errorList.add("Step 2 - Link");
            if (!generalMethods.compareImages2(folderName, "Step7.2", null))
                //If FALSE, add step name to the error list
                errorList.add("Step 2 - image");
        } else {
    ...
    public void Step8_Gallery() throws Exception {
        ...
        generalMethods.openURL(testEnvironment, 10);
        generalMethods.hoverOnOneOfElement(ewePageObject.getHeaderItems(), 1);
        generalMethods.clickOnOneOfElements(ewePageObject.getHeaderMenuLinks(), 0);
        ...
        if (!generalMethods.compareResult(url.contains(galleryPage),
            ...
            //If FALSE, add step name to the error list
            errorList.add("Step 1 - Link");
        if (!generalMethods.compareImages2(folderName, "Step8.1", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 1 - image");
        ...
        if (!generalMethods.compareImages2(folderName, "Step8.2", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 2 - image");
    ...
    public void Step9_ChangeLanguage() throws Exception {
        ...
        generalMethods.openURL(testEnvironment, 10);
        generalMethods.selectFromDropDown(ewePageObject.getChangeLanguage(), "De");
        generalMethods.waitInSeconds(3);
        String url = driver.getCurrentUrl();
        ...
        if (!generalMethods.compareImages2(folderName, "Step9.1", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 1 - image");

        generalMethods.printTestStep("2. Change to FR ");
        generalMethods.selectFromDropDown(ewePageObject.getChangeLanguage(), "Fr");
        generalMethods.waitInSeconds(3);
        url = driver.getCurrentUrl();
        if (!generalMethods.compareResult(url.contains("/fr/"),
            ...
            errorList.add("Step 2 - Link");
        generalMethods.hideElements(ewePageObject.getSlideshow());
        if (!generalMethods.compareImages2(folderName, "Step9.2", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 2 - image");

        generalMethods.printTestStep("2. Change to EN ");
        generalMethods.selectFromDropDown(ewePageObject.getChangeLanguage(), "En");
        generalMethods.waitInSeconds(3);
        url = driver.getCurrentUrl();
        ...
        generalMethods.hideElements(ewePageObject.getSlideshow());
        if (!generalMethods.compareImages2(folderName, "Step9.3", null))
            //If FALSE, add step name to the error list
            errorList.add("Step 3 - image");
