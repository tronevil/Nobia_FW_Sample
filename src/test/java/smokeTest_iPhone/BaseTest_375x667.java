...
public class BaseTest_375x667 {

    protected static GeneralMethods commonMethods = new GeneralMethods();
    protected static WebDriver driver;
    protected String folderName = "iPhone/" + this.getClass().getSimpleName();
        ...
        switch (driverType) {
            case "chrome": {
                ...
                mobileEmulation.put("userAgent",
                        "Mozilla/5.0 (iPhone;" +
                                "CPU iPhone OS 11_0 like Mac OS X) AppleWebKit/604.1.38 (KHTML, like Gecko) " +
                                "Version/11.0 Mobile/15A372 Safari/604.1 qa-testing"
                );
